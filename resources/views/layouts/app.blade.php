...
<body id="app-layout">
    ...
    <!-- For secure iframe communication -->
    <script type="text/javascript" src="{{asset('assets/js/porthole.min.js')}}"></script>

    <script type="text/javascript">
            var guestDomain = 'brainplay.comxa.com';
            ...
            window.onload=function(){ 
                    ...
                    windowProxy1 = new Porthole.WindowProxy('http://' + guestDomain + '/project1%20-%20Storyline%20output/story_html5.html', 'loginFrame');
